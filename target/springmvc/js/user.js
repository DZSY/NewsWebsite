...
$(function() {
    ...
    $("#login-submit").on("click", function(e){
        ...
        else if (!(/^[a-z,A-Z,0-9,_]+$/).test($('#login-username').val()))
        {
            $('#login-feedback').html("用户名只能由数字、大小写字母和下划线组成");
        }
    ...
    $("#register-submit").on("click", function(e){
        ...
        else if (!(/^[a-z,A-Z,0-9,_]+$/).test($('#register-username').val()))
        {
            $('#register-feedback').html("用户名只能由数字、大小写字母和下划线组成");
        }
