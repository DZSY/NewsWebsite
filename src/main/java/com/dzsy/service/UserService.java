...
public class UserService {
    ...
    public String Register(String username, String password, String email) {
        ...
        StringBuffer sb=new StringBuffer("亲爱的 " + username + " 您好，您的激活码是 " +
                "<span style=\"border:1px; background:#CAFF70; color:#458B00\">" + activation + "</span>" +
                " ，请尽快验证。");
    ...
    private void sendEmail(String to, String content) {
        ...
        //                  QQ邮箱的SMT他邮箱自行去查看)P(SLL)端口为465或587, 其
        ...
        */
        ...
        try {
            ...
            // 3. To: 收件人
            message.setRecipient(MimeMessage.RecipientType.TO, new InternetAddress(to, "USER_CC", "UTF-8"));
            // 4. Subject: 邮件主题
            message.setSubject("来自新新新闻网的激活邮件", "UTF-8");
            ...
            transport.connect("xinxinnews@aliyun.com", "xinxin123456");
